...
//         return "asdfghjk-kjhgfds-dfghj-sdfghjk";
        try {
            ResponseEntity<IdamUserIdDetailsResponse> responseEntity = getResponseEntity(headers);
    ...
    private ResponseEntity<IdamUserIdDetailsResponse> getResponseEntity(MultiValueMap<String, String> headers) {
