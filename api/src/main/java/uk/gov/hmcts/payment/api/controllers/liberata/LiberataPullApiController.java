package uk.gov.hmcts.payment.api.controllers.liberata;
...
@RestController
@Api(tags = {"Payment"})
@SwaggerDefinition(tags = {@Tag(name = "LiberataPullApiController", description = "Payment REST API")})
public class LiberataPullApiController {

    private static final Logger LOG = LoggerFactory.getLogger(LiberataPullApiController.class);
    ...
    @Autowired
    public LiberataPullApiController(PaymentService<PaymentFeeLink, String> paymentService,
