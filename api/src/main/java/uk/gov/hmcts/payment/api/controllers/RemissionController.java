...
public class RemissionController {
    ...
    public ResponseEntity<RemissionDto> createRemission(@Valid @RequestBody RemissionRequest remissionRequest,
        ...
        OrganisationalServiceDto organisationalServiceDto = referenceDataService.getOrganisationalDetail(java.util.Optional.ofNullable(remissionRequest.getCaseType()), Optional.empty(), headers);
