...
@AllArgsConstructor
@NoArgsConstructor
public class PbaIacPaymentReportConfig implements PaymentReportConfig<PaymentDto> {
    ...
    private String from;
    @Value("${pba.iac.payments.email.to:dummy}")
    private String[] to;
    @Value("${pba.iac.payments.email.subject:dummy}")
    private String subject;
    @Value("${pba.iac.payments.email.message:dummy}")
    private String message;
    @Value("${pba.iac.payments.report.scheduler.enabled:false}")
