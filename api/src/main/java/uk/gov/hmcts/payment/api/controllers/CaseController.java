...
public class CaseController {
    ...
    public RetrievePaymentGroupsResponse retrieveCasePaymentGroups(@PathVariable(name = "ccdcasenumber") String ccdCaseNumber) {
        ...
        return new RetrievePaymentGroupsResponse(paymentGroups);
    }
