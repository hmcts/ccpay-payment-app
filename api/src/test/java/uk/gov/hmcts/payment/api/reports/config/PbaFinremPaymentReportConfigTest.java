...
public class PbaFinremPaymentReportConfigTest {
    PbaFinremPaymentReportConfig pbaFinremPaymentReportConfig = new PbaFinremPaymentReportConfig();

    @Test
    public void testGetType(){
        PaymentReportType type = pbaFinremPaymentReportConfig.getType();
        assertEquals(PaymentReportType.PBA_FINREM, type);
    }
    ...
    public void testGetCsvHeader(){
        ...
        String response = pbaFinremPaymentReportConfig.getCsvHeader();
        assertEquals(expected,response);
    }

    @Test
    public void testGetCsvFileNamePrefix(){
        String expected = "hmcts_credit_account_payments_finrem_";
        String response = pbaFinremPaymentReportConfig.getCsvFileNamePrefix();
        assertEquals(expected,response);
    }
}
