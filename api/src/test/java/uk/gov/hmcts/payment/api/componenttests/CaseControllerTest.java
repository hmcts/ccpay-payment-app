...
import uk.gov.hmcts.payment.api.dto.RetrievePaymentGroupsResponse;
...
public class CaseControllerTest extends PaymentsDataUtil {
    ...
    public void searchAllPaymentsWithCcdCaseNumberShouldReturnRequiredFieldsForVisualComponent() throws Exception {
        ...
        ReconciliationPaymentsResponse payments = objectMapper.readValue(result.getResponse().getContentAsByteArray(), new TypeReference<ReconciliationPaymentsResponse>(){});

        assertThat(payments.getPayments().size()).isEqualTo(1);

        ReconciliationPaymentDto payment = payments.getPayments().get(0);
...
//        assertThat(payment.getReference()).isNotBlank();
    ...
    public void shouldReturnStatusHistoryWithErrorCodeForSearchByCaseReference() throws Exception {
        ...
        ReconciliationPaymentDto paymentDto = payments.getPayments().get(0);
    ...
    public void searchAllPaymentGroupsWithCcdCaseNumberShouldReturnRequiredFields() throws Exception {
        ...
        RetrievePaymentGroupsResponse paymentGroups = objectMapper.readValue(result.getResponse().getContentAsByteArray(), new TypeReference<RetrievePaymentGroupsResponse>(){});
