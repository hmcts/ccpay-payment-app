...
//            assertThat(paymentDto.getReference()).isEqualTo(response.getReference());
            ...
            LiberataFeeDto feeDto1 = paymentDto.getFees().stream().filter(f -> f.getReference().equals("CASE_111")).findAny().get();
            ...
            LiberataFeeDto feeDto2 = paymentDto.getFees().stream().filter(f -> f.getReference().equals("CASE_222")).findAny().get();
            assertThat(feeDto1).isNotNull();
            assertThat(feeDto1.getCode()).isEqualTo("FEE0001");
    ...
    public void testPaymentForCaseSingleCaseMultipleFees() throws Exception {
        ...
        if (optPayment.isPresent()) {
            ...
            assertThat(paymentDto.getFees().size()).isEqualTo(2);
            LiberataFeeDto fee1 = payment.getFees().stream().filter(f -> f.getCode().equals("FEE0205")).findAny().get();
            ...
            LiberataFeeDto fee2 = payment.getFees().stream().filter(f -> f.getCode().equals("FEE0206")).findAny().get();
