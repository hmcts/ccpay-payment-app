...
public class PaymentsDataUtil {
    ...
    public SupplementaryMainDto populateIACSupplementaryDetails(String number) throws Exception {
        ...
        SupplementaryMainDto supplementaryMainDto = SupplementaryMainDto.supplementaryMainDtoWith()
    ...
    public SupplementaryMainDto populateIACSupplementaryDetailsWithMissingCCDNumbers(String number) throws Exception {
