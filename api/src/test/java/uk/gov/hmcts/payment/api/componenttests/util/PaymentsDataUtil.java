...
public class PaymentsDataUtil {
    ...
    public Payment populateCardPaymentToDb(String number, String reference) throws Exception {
        ...
        PaymentFee fee = feeWith().calculatedAmount(new BigDecimal("99.99")).version("1")
    ...
    public Payment populateCreditAccountPaymentToDbWithNetAmountForFee(String number, BigDecimal calculatedAmount, BigDecimal netAmount)
        throws Exception {
        //Create a payment in remissionDbBackdoor
        Payment payment = Payment.paymentWith()
