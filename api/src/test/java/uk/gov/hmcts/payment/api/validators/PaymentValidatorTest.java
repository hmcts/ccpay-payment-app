...
public class PaymentValidatorTest {
    ...
    public void shouldReturnNoErrors() {
        ...
        validator.validate("ALL", Optional.of(NOW_STRING), Optional.of(NOW_STRING));
    }

    @Test
    public void shouldReturnNoErrorsWhenDatesEmpty() {
        // no exception expected, none thrown: passes.
        validator.validate("ALL", Optional.empty(), Optional.empty());
    }

    @Test
    public void shouldThrowValidationExceptionWithPaymentMethodError() {

        Throwable thrown = catchThrowable(() -> { validator.validate("UNKNOWN", Optional.of(NOW_STRING), Optional.of(NOW_STRING)); });
    ...
    public void shouldThrowValidationExceptionWithFutureStartDateError() {
        ...
        Throwable thrown = catchThrowable(() -> { validator.validate("ALL", Optional.of(FUTURE_STRING), Optional.of(NOW_STRING)); });
    ...
    public void shouldThrowValidationExceptionWithFutureEndDateError() {
        ...
        Throwable thrown = catchThrowable(() -> { validator.validate("ALL", Optional.of(NOW_STRING), Optional.of(FUTURE_STRING)); });
    ...
    public void shouldThrowValidationExceptionWhenStartDateIsGreaterThanEndDate() {
        ...
        Throwable thrown = catchThrowable(() -> { validator.validate("ALL", Optional.of(NOW_STRING), Optional.of(LocalDate.now().minusDays(1).format(ISO_DATE))); });
