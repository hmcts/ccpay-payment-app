...
public class PBAPaymentFunctionalTest {
    ...
    public void makeAndRetrievePBAPaymentByCMCTestShouldReturnAutoApportionedFees() {
        ...
        fees.add(FeeDto.feeDtoWith().code("FEE0271").ccdCaseNumber("9999881277776666").feeAmount(new BigDecimal(20))
            .volume(1).version("1").calculatedAmount(new BigDecimal(20)).build());
        fees.add(FeeDto.feeDtoWith().code("FEE0271").ccdCaseNumber("9999881277776666").feeAmount(new BigDecimal(40))
            .volume(1).version("1").calculatedAmount(new BigDecimal(40)).build());
        fees.add(FeeDto.feeDtoWith().code("FEE0271").ccdCaseNumber("9999881277776666").feeAmount(new BigDecimal(60))
        ...
        CreditAccountPaymentRequest accountPaymentRequest = CreditAccountPaymentRequest.createCreditAccountPaymentRequestDtoWith()
            ...
            .ccdCaseNumber("9999881277776666")
            .service(Service.CMC)
